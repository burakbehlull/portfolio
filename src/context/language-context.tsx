...
const dictionary: Record<Language, Record<string, string>> = {
  en: {
    ...
    aboutPageHello: "Hello! I'm a developer passionate about building great digital experiences.",
    aboutPagePlaceholder: "(This is a placeholder page. You can add more content here later.)",
  ...
  tr: {
    ...
    aboutPageHello: "Merhaba! Harika dijital deneyimler oluşturmaya tutkulu bir geliştiriciyim.",
    aboutPagePlaceholder: "(Bu bir yer tutucu sayfadır. Daha sonra buraya daha fazla içerik ekleyebilirsiniz.)",
