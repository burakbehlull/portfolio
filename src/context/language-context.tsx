...
const dictionary: Record<Language, Record<string, string>> = {
  en: {
    ...
    speaking: "Speaking",
    about: "About",
    heroTitle: "Hey, I'm [Your Name]",
    heroSubtitle: "Creative Developer",
    heroDescription: "I craft intuitive digital experiences where design meets functionality. Based in [Location], bringing ideas to life through code and creativity.",
    letsTalk: "Let's talk",
  ...
  tr: {
    ...
    speaking: "Konuşmalar",
    about: "Hakkımda",
    heroTitle: "Selam, Ben [Adınız]",
    heroSubtitle: "Kreatif Geliştirici",
    heroDescription: "Tasarımın işlevsellikle buluştuğu sezgisel dijital deneyimler tasarlıyorum. [Konum]'da kod ve yaratıcılıkla fikirleri hayata geçiriyorum.",
    letsTalk: "Konuşalım",
